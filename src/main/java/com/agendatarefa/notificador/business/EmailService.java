package com.agendatarefa.notificador.business;

import com.agendatarefa.notificador.dto.TarefasDTO;
import com.agendatarefa.notificador.infrastructure.exceptions.SendEmailException;
...
public class EmailService {
    ...
    public void enviarEmail(TarefasDTO dto) {
        try {
            ...
            throw new SendEmailException("Falha ao enviar email", e.getCause());
        }
    }
}
